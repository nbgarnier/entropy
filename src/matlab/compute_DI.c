...
//    int     ret=0;
    ...
    if (do_use_mask==1) compute_directed_information_ann_mask(x,y, mask, npts, mx, my, N, stride, k, xout1, xout2);
    else                compute_directed_information_ann     (x,y,       npts, mx, my, N, stride, k, xout1, xout2);
