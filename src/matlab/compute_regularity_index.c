...
{   double *x;
    ...
    if (nrhs > 4) mexErrMsgTxt("Wrong number of input parameters, "
                "this function requires 1, 2, 3, 4 or 5 parameters. "
                "masks not coded yet."
				"See help for more information.\n");
    ...
    /* 3rd input parameter contains sampling parameters : */
    ...
    if (do_use_mask==0) compute_regularity_index_ann(x,       npts, mx, px, stride, k, Theiler, N_eff, N_real, I1, I2);
