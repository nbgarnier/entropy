% [T1, T2, std1, std2, ...] = compute_TE(x, y, z, [embed_params, [algo_params, [mask]]])
% 
% Compute partial transfer entropy from y to x, under conditionning on z
% 
% x, y, z      : n-d arrays containing the data 
...
%   mz         : number of points in the past of z to be considered (embedding) (default 1)
